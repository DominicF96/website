...
export const components = {
    h1: (props: HeadingProps) => (
        <h1 className="text-3xl md:text-4xl font-bold mt-6 uppercase" {...props} />
    ),
    h2: (props: HeadingProps) => (
        <h2 className="text-2xl md:text-3xl font-bold mt-6 uppercase" {...props} />
    ),
    h3: (props: HeadingProps) => (
        <h3 className="text-xl md:text-2xl font-bold mt-6 uppercase" {...props} />
    ),
    h4: (props: HeadingProps) => (
        <h4 className="text-lg md:text-xl font-bold mt-6 uppercase" {...props} />
    ),
    h5: (props: HeadingProps) => (
        <h5 className="text-md md:text-lg font-bold mt-6 uppercase" {...props} />
    ),
